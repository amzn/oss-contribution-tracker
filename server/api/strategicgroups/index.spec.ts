...
describe('index', () => {
  ...
  beforeEach(() => {
    ...
    mock = {
      dbcontributions: {
        ...
        getLastMonthCount: jasmine.createSpy('dbcontributions').and.returnValue({
          numcontribs: '3'
        }),
      ...
      dbgroups: {
        ...
        searchGroupIdsByProjectId: jasmine.createSpy('dbgroups').and.callFake((projectId) => {
          if (projectId === 1) {
            return { groups: [1,2] }
          } else if (projectId === 2) {
            return { groups: [1] }
        ...
        getGroupsByProjectId: jasmine.createSpy('dbgroups').and.callFake((projectId) => {
      ...
      dbprojects: {
        getAllStrategicProjects: jasmine.createSpy('dbprojects').and.returnValue([
          {
            project_id: 1,
            project_name: 'A',
            project_url: 'A.com',
        ...
        getProjectsByGroup: jasmine.createSpy('dbprojects').and.callFake((groupId) => {
          if (groupId === 1) {
            return [
              {
                project_id: 1,
  ...
  describe('strategic groups', () => {
    it('should list all strategic groups', async (done) => {
      ...
      expect(groups).toEqual({ groupList:
       [ { group_id: 1,
           group_name: 'Test 1',
           projects: [1,2],
           numUsers: 2,
